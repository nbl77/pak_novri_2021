...
class Init
{
    ...
    private static function initLayout()
    {
        ...
        Metronic::addClass('body_blog', 'quick-panel-right');
        Metronic::addClass('body_blog', 'demo-panel-right');
        Metronic::addClass('body_blog', 'offcanvas-right');
    }
    ...
    private static function initPageLoader()
    {
        if (!empty(config('layout.page-loader.type'))) {
            ...
            Metronic::addClass('body_blog', 'page-loading-enabled');
            Metronic::addClass('body_blog', 'page-loading');
        }
    }
    ...
    private static function initHeader()
    {
        if (config('layout.header.self.fixed.desktop')) {
            ...
            Metronic::addClass('body_blog', 'header-fixed');
        } else {
          Metronic::addClass('body_blog', 'header-static');
